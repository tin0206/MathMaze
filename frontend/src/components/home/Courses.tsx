                ...
                {courses.map((course) => (
                    <li key={course.id} className="p-6 md:p-[45px] flex flex-col bg-[#ffffff] rounded-[10px] gap-y-[24px] md:gap-y-[30px]">
                        <div className="w-full flex items-center justify-center">
                            <img src={course.image ? course.image : "/placeholder.png"} alt={course.title} className="max-h-[500px] rounded-[10px]" />
                        </div>
                        <div className="w-full flex items-center">
                            <div className="flex flex-col xl:flex-row w-full justify-between xl:items-center gap-y-3 xl:gap-y-0">
